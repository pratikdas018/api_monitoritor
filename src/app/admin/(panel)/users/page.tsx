...
export default async function AdminUsersPage({ searchParams }: AdminUsersPageProps) {
  ...
  return (
    <div className="space-y-4 lg:space-y-5">
      <header>
        <h2 className="text-xl font-semibold text-slate-100 sm:text-2xl">User Management</h2>
        <p className="mt-1 text-sm text-slate-400">View, suspend, or delete platform users.</p>
      </header>
